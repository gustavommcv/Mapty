...
const containerWorkouts = document.querySelector('.main__workouts');
...
class App {
    ...
    _renderWorkout(workout) {
        let html = `
        <li class="aworkout workout--${workout.type}" data-id="${workout.id}">
    ...
    _moveToPopup(e) {
        const workoutEl = e.target.closest('.aworkout');
